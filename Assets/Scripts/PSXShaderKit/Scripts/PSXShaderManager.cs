...
namespace PSXShaderKit
{
    ...
    public class PSXShaderManager : MonoBehaviour
    {
        ...
        //public void SetVertexWarpResolution(float a) { 
        //
        //  }
        void OnValidate()
        {
        ...
        /*[SerializeField] float minWarp = 10f;
        [SerializeField] float maxWarp = 120f;
        [SerializeField] float t = 0f;

        void Update()
        {
            _VertexGridResolution = Mathf.Lerp(minWarp, maxWarp, t);
